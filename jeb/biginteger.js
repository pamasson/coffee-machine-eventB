/*
    ...
    Derived from version 0.9
    
    changes in version 0.9.1: 
      # remove the "valueOf" function
      # replace the "valueOf" function by the "toJSValue" function
...
BigInteger.prototype.toString = function(base) {
	...
	if (base === 10) {
		...
		while (n._s !== 0) {
			...
			digits.push(numerals[digit.toJSValue()]);
		}
...
BigInteger.prototype.log = function() {
	...
	return Math.log((new BigInteger(firstNdigits, 1)).toJSValue()) + (l - N) * Math.log(BigInteger.base);
};
